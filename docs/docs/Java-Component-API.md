...
* Audio And Video Detection Component Adapter ([source](https://github.com/openmpf/openmpf-java-component-sdk/blob/master/java-component-api/src/main/java/org/mitre/mpf/component/api/detection/adapters/MPFAudioAndVideoDetectionComponentAdapter.java))
...
| Parameter  | Data Type  | Description  |
|---|---|---|
| job  | `MPFGenericJob`  | Structure containing details about the work to be performed. See [`MPFGenericJob`](#mpfgenericjob) |

* Returns:

| Data Type | Description |
|---|---|
| `List<MPFGenericTrack>` |  The [`MPFGenericTrack`](#mpfgenerictrack) data for each detected object  |
