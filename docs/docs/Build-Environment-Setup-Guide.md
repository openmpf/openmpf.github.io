...
7. OpenCV:
    <br><br>**IMPORTANT:** If building the master branch as of [this commit](https://github.com/openmpf/openmpf-projects/commit/8527d4e303559a14eb7df9ce9f1d5eeee285238b) or earlier, then follow the instructions below for OpenCV 3.1.0. If building the develop branch, "r0.10.0" branch, or a branch for a later release, then follow the instructions below for OpenCV 3.2.0. Don't install both.
    1. OpenCV 3.1.0
